...
<body>
    ...
    $payMethod="ALL";
    $lang="E";
    $sucess = "https://dev.yourbestwayhome.com.au/EuroCar/detail.php?cnfNo=$cnfNo&lName=$lName&vdNo=$vdNo";
    $successUrl=$sucess;
    $failUrl="http://www.yourdomain.com/fail.html";
    $cancelUrl="https://dev.yourbestwayhome.com.au/EuroCar/index.php";
